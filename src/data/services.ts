...
export const services: Service[] = [
  {
    ...
    description:
      "DGFTは、請求書をクレジットカードで決済できるサービスです。最短即日での入金対応と、業界トップクラスの低手数料が特徴。法人・個人事業主どちらにも対応しています。",
    rating: 4.8,
    reviewCount: 312,
  ...
  },
  {
    ...
    description:
      "支払い.comは、最速翌営業日入金を実現する請求書カード払いサービスです。独自の審査システムにより、スピーディーかつ柔軟な審査対応が強みです。",
    rating: 4.6,
    reviewCount: 245,
  ...
  },
  {
    ...
    description:
      "INVOYは、初めて請求書カード払いを利用する方でも安心して使えるよう、専任サポートチームが導入から運用まで伴走するサービスです。",
    rating: 4.5,
    reviewCount: 198,
  ...
  },
  {
    ...
    description:
      "ラボルカード払いは、与信審査なしで請求書をカード払いに変換できる画期的なサービス。創業直後や信用情報に不安のある方でも安心して利用できます。",
    rating: 4.3,
    reviewCount: 156,
  ...
  },
  {
    ...
    description:
      "マネーフォワード請求書カード払いは、主要会計ソフト・クラウド経費精算ツールと連携した請求書カード払いサービス。請求書管理から支払い、仕訳まで一括で効率化できます。",
    rating: 4.2,
    reviewCount: 134,
  ...
  },
  {
    ...
    description:
      "LP請求書カード払いは、100万円以上の高額請求書に特化した請求書カード払いサービス。大口ユーザー向けの特別手数料と、専任の法人サポートが強みです。",
    rating: 4.0,
    reviewCount: 98,
  ...
  },
  {
    ...
    name: "Fintoカード後払い",
    shortName: "Finto",
    logoUrl: "/images/logo-g.png",
    officialUrl: "https://example.com/service-g",
    resourceUrl: "https://example.com/service-g/contact",
    catchphrase: "",
    description:
      "Fintoカード後払いは、請求書をクレジットカードで後払いできるサービスです。",
    rating: 0,
    reviewCount: 0,
    scores: { fee: 0, speed: 0, support: 0, usability: 0 },
    ranks: { overall: 7, fee: 7, payment: 7, screening: 7 },
    fee: "X.X%〜",
    feeDetail: "",
    paymentSpeed: "",
    paymentSpeedDetail: "",
  ...
  },
  {
    ...
    name: "フリーウェイ請求書カード払い",
    shortName: "フリーウェイ",
    logoUrl: "/images/logo-h.png",
    officialUrl: "https://example.com/service-h",
    resourceUrl: "https://example.com/service-h/contact",
    catchphrase: "",
    description:
      "フリーウェイ請求書カード払いは、請求書をクレジットカードで支払えるサービスです。",
    rating: 0,
    reviewCount: 0,
    scores: { fee: 0, speed: 0, support: 0, usability: 0 },
    ranks: { overall: 8, fee: 8, payment: 8, screening: 8 },
    fee: "X.X%〜",
    feeDetail: "",
    paymentSpeed: "",
    paymentSpeedDetail: "",
